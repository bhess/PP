#ifndef CRYPTOPP_RANDPOOLOLD_H
#define CRYPTOPP_RANDPOOLOLD_H
...
/*! This class can be used to generate
	...
	the Put() methods */
class CRYPTOPP_DLL RandomPoolOld : public RandomNumberGenerator,
				   public Bufferless<BufferedTransformation>
{
public:
	//! poolSize must be greater than 16
	RandomPoolOld(unsigned int poolSize=384);
